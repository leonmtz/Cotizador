...
<head>
    ...
    <title>Login - Sistema Cotizador</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" id="loginForm">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="email" name="email" aria-describedby="emailHelp" placeholder="Usuario" required autocomplete="email">
                                        </div>
                                        <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href = "/Cotizador/resources/index.php";
                        } else {
                    ...
                    error: function() {
                        $("#responseMessage").html("<div class='alert alert-danger'>Ocurrió un error. Inténtalo de nuevo.</div>");
                    }
                });
            });
        });
